...
assert(repository.includes('SCHEMA_VERSION = 7') && repository.includes("message.dataContext === 'seed'") && repository.includes('clearAiMessages'), 'demo clearing must remove only seed-context AI conversations and support explicit history clearing')
